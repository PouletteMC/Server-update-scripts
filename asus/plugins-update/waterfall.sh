...
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/masuite/MaSuiteChat.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/masuite/MaSuiteHomes.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/masuite/MaSuitePortals.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/masuite/MaSuiteTeleports.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/masuite/MaSuiteWarps.sh)
...
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/MoveMeNow.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/ServerListPlus.sh)
bash <(curl -s https://raw.githubusercontent.com/PouletteMC/Server-update-scripts/main/asus/plugins-update/plugins/TAB.sh)
